...
public class InitConfig {
    ...
    CommandLineRunner initCommandLineRunner(
        ...
        return args -> {
            ...
            lectureRepository.saveAll(List.of(a1MathVenus, a2MathVenus,
                    a1physicsJupyter));
            ...
            gradeRepository.saveAll(List.of(luneMathVenus, lunePhysicsJupyter,
                    soleiMathVenus, soleiPhysicsJupyter));
